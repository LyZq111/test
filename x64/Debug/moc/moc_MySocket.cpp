...
QT_MOC_LITERAL(4, 28, 10), // "dataToSend"
QT_MOC_LITERAL(5, 39, 20), // "readPendingDatagrams"
QT_MOC_LITERAL(6, 60, 8) // "sendData"

    },
    "MySocket\0dataReceived\0\0data\0dataToSend\0"
    "readPendingDatagrams\0sendData"
};
...
void MySocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->dataToSend((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MySocket::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySocket::dataReceived)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MySocket::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySocket::dataToSend)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MySocket::dataReceived(const QString & _t1)
{
...
// SIGNAL 1
void MySocket::dataToSend(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
